...
class ISRNet(nn.Module):
    def __init__(self, n_resgroups: int, n_resblocks: int, planes: int, scale: int,
        ...
        modules_body = [
            ResidualGroup(block_type, n_resblocks, planes, act_mode=act_mode, prob=prob[i], **kwargs)
...
class Model(nn.Module):
    ...
    def make_model(self, cfg):
        ...
        # build a probability list for stochastic depth 构建随机深度的概率列表
